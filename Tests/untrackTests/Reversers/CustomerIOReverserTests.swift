...
final class CustomerIOReverserTests: XCTestCase {
    let rev = CustomerIOReverser()
    let logger = Logger(level: .debug)
    let components = URLComponents(
        url: URL(
            string:
                "https://e.customeriomail."
        )!,
